...
const AddStopRoute = () => {
    ...
    //AGGIUNGI TAPPA
    const addTourStop = () => {
        setTourStops([...tourStops, { id: tourStops.length +1, cover: file, date: eventDate, mainPlace: eventPlace, city: eventCity, address: eventAddress, province: eventProvince, zipCode: eventCap }])
        navigate(-1)
    }
