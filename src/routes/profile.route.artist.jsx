...
const ProfileArtistRoute = () => {
  ...
  return (
    ...
    <ContainerDefault containerSpecificStyle='pt-xs-topbar pb-xs-appbar'>
      <h1>Profilo</h1>
      <div id='profile' className='mt-xs-2 d-flex-column align-items-start mb-xs-12'>
      ...
      <div id='dati' className="d-flex-column j-c-center align-items-start bg-dark-gradient border-radius-08 w-100 pt-xs-4 pb-xs-4 pr-xs-4 pl-xs-4">
        {(currentArtist?.name === '' && currentArtist?.surname==='' && currentArtist?.iban==='') ?
          <>
        ...
        : (currentArtist?.name === '' || currentArtist?.surname ==='' || currentArtist?.iban ==='') ?
          ...
          <div className='mb-xs-2'>
            ...
            {currentArtist?.name !== '' ? (<h6 className='fsize-xs-2 f-w-300 grey-50 letter-spacing-1 mt-xs-2'>{currentArtist?.name}</h6>) : (<div className="bg-red-400-transp10 red-500 d-flex-row j-c-center align-items-center border-radius-02 fsize-xs-2">Nome mancante</div>)}
          </div>
          <div className='mt-xs-2 mb-xs-2'>
            <label className='fsize-xs-1 grey-300 letter-spacing-3'>{'COGNOME'}</label> 
            {currentArtist?.surname !== '' ? (<h6 className='fsize-xs-2 f-w-300 grey-50 letter-spacing-1 mt-xs-2'>{currentArtist?.surname}</h6>) :(<div className="bg-red-400-transp10 red-500 d-flex-row j-c-center align-items-center fsize-xs-2">Cognome mancante</div>)}          
          </div>
          <div className='mt-xs-2 mb-xs-8'>
            <label className='fsize-xs-1 grey-300 letter-spacing-3'>{'IBAN'}</label> 
            {currentArtist?.iban !== '' ? (<h6 className='fsize-xs-2 f-w-300 grey-50 letter-spacing-1 mt-xs-2'>{currentArtist?.iban}</h6>) :(<div className="bg-red-400-transp10 red-500 d-flex-row j-c-center align-items-center fsize-xs-2">IBAN mancante</div>)}          
          </div>
          <Button
        ...
        :
          ...
          <div className='mb-xs-2'>
            <label className='fsize-xs-1 grey-300 letter-spacing-3'>{'NOME'}</label> 
            <h6 className='fsize-xs-2 f-w-300 grey-50 letter-spacing-1 mt-xs-2'>{currentArtist?.name}</h6>
          </div>
          <div className='mt-xs-2 mb-xs-2'>
            <label className='fsize-xs-1 grey-300 letter-spacing-3'>{'COGNOME'}</label> 
            <h6 className='fsize-xs-2 f-w-300 grey-50 letter-spacing-1 mt-xs-2'>{currentArtist?.surname}</h6>
          </div>
          <div className='mt-xs-2 mb-xs-8'>
            <label className='fsize-xs-1 grey-300 letter-spacing-3'>{'IBAN'}</label> 
      ...
      <div id='profile-settings' className='mt-xs-12 '>
      ...
      <div id='logout' className="mt-xs-4">
        <p className="fsize-xs-2 blue-500">Log out</p>
      </div>
