  ...
  return (
    <div className='d-flex-column j-c-center gap-0_5em w-100 bg-dark-gradient border-radius-08 pl-xs-8 pr-xs-8 pt-xs-6 pb-xs-6 mt-xs-4'>
        ...
        <div className='d-flex-row align-items-center j-c-space-between'>
            ...
            <img className='avatar-32 ml-xs-2' src={IconCopyLime} alt='points' onClick={() =>triggerSnackbar(`Importo copiato: € ${formatNumber(widgetValue)}`)}/>
        </div>
        ...
        <div className="d-flex-row mt-xs-4 j-c-space-between align-items-center">
            ...
            <img className='avatar-32 ml-xs-2' src={IconCopyLime} alt='points' onClick={() =>triggerSnackbar(`Azienda copiata: MIDLY S.R.L`)}/>
        </div>
        <div className="d-flex-row mt-xs-4 j-c-space-between align-items-center">
            <p className='fsize-xs-1 grey-300 letter-spacing-2'>{'P.IVA: IT11161730962'}</p>
            <img className='avatar-32 ml-xs-2' src={IconCopyLime} alt='points' onClick={() =>triggerSnackbar(`P.IVA copiata: IT11161730962`)} />
        </div>
        <div className="d-flex-row mt-xs-4 j-c-space-between align-items-center">
            <p className='fsize-xs-1 grey-300 letter-spacing-2'>{'C.F: 11161730962'}</p>
            <img className='avatar-32 ml-xs-2' src={IconCopyLime} alt='points' onClick={() =>triggerSnackbar(`C.F copiato: 11161730962`)}/>
        </div>
        <div className="d-flex-row mt-xs-4 j-c-space-between align-items-center">
            <p className='fsize-xs-1 grey-300 letter-spacing-2'>{'Via umberto maddalena, 20 20824 - LAZZATE (MB) - IT'}</p>
            <img className='avatar-32 ml-xs-2' src={IconCopyLime} alt='points' onClick={() =>triggerSnackbar(`Indirizzo copiato`)}/>
        </div>
        <div className="d-flex-row mt-xs-4 j-c-space-between align-items-center">
            <p className='fsize-xs-1 grey-300 letter-spacing-2'>{'Codice destinatario: W7YVJK9'}</p>
            <img className='avatar-32 ml-xs-2' src={IconCopyLime} alt='points' onClick={() =>triggerSnackbar(`Codice destinatario copiato: W7YVJK9`)}/>
        </div>
    </div>
  )
}
