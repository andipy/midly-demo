...
const CardArtist = ({ slug, artistName, image, isFollowed}) => {
    return (
        <a className='mr-xs-2' href={`/artist/${slug}`}>
            <div className='artist-card-multiple-row bg-dark-gradient border-radius-1 position-relative'>
                <div className='overlay-card bg-dark-overlay-card border-radius-1 z-index-1'></div>
                <img className='artist-card-multiple-row object-fit-cover border-radius-1' src={image} alt=""/>
                ...
                {isFollowed && (
                    <>
                    <div className="overlay-card-followed border-radius-1  z-index-3 bg-grey-transp50">
                    </div>
                    <div className="d-flex-row j-c-center align-items-center overlay-card-followed border-radius-1 z-index-4">
