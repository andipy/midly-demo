        ...
        <FullPageCenter style='z-index-1000 bg-black-transp70'>
            <Container style={`centered-popup ${isExitingSettings ? 'fade-out' : ''} position-absolute d-flex-row align-items-center`}>
                ...
                <Carousel>
                    ...
                    <div className="d-flex-row bg-brand-gradient pt-xs-04 pb-xs-04 pl-xs-04 pr-xs-04 border-radius-08">
                        <div className="bg-dark-gradient  border-brand-gradient artist-card-highlight-multiple position-relative  overflow-clip border-radius-08 no-shrink pt-xs-4 pb-xs-4 pr-xs-4 pl-xs-4  d-flex-column j-c-space-between align-items-center h-min-100">
                            <div className="d-flex-column j-c-start align-items-center">
                                ...
                                <div className="d-flex-column j-c-center align-items-center pt-xs-6 pb-xs-6 pl-xs-4 pr-xs-4 border-lime-1 border-radius-08 mt-xs-4 position-relative overflow-all-hidden">
                                    <p className="fsize-xs-3 f-w-300">€<span className="fsize-xs-5 f-w-600">3.99</span>/mese</p>
                                </div>
                    ...
                    {/* ANNO */}
                    <div className="d-flex-row bg-brand-gradient pt-xs-04 pb-xs-04 pl-xs-04 pr-xs-04 border-radius-08">
                        <div className="bg-dark-gradient artist-card-highlight-multiple position-relative  overflow-clip border-radius-08 no-shrink  pt-xs-4 pb-xs-4 pr-xs-4 pl-xs-4  d-flex-column j-c-space-between align-items-center h-min-100">
                            <div className="d-flex-column j-c-start align-items-center">
                                <div className="w-100 d-flex-row j-c-end align-items-center" onClick={() => setIsExitingSettings(true)}>
                                    <div className="avatar-28 border-radius-100 d-flex-row j-c-center align-items-center"><img src={IconExit} /></div>
                                </div>
