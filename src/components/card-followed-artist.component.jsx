...
const CardFollowedArtist = ({ artist }) => {
    ...
    return (
        <div onClick={() => navigate(`/artist/${artist?.slug}`, { state : {artist: artist} })} className='d-flex-row align-items-center bg-dark-gradient border-radius-1 mb-xs-3 pt-xs-2 pb-xs-2 pl-xs-2 pr-xs-2 gap-0_5em'>                        
