...
const LiveMusicProduct = () => {
    ...
    return (
        <div className="d-flex-row align-items-center j-c-space-between gap-0_5em">
            <Link className="w-music-product d-inline-flex-row align-items-center j-c-space-between gap-0_5em bg-black-transp50 border-radius-100 pl-xs-4 pr-xs-2 pt-xs-1 pb-xs-1" to='https://open.spotify.com/intl-it/track/5Hjy8lyZ4h99OjrW8jzPQ8' target='blank'>
                ...
                <span className="fsize-xs-2 green-spotify f-w-600 t-overflow-ellipsis overflow-hidden flex-no-wrap">{product}</span>
