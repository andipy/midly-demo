...
const MessageFlashLeaderboard = ({ state }) => {
    ...
    return (
        ...
        {state.artName == 'thasup' ?
            <div className="d-flex-row align-items-center j-c-space-between bg-dark-soft border-radius-100 border-red-dashed-1 pl-xs-4 pr-xs-1 pt-xs-1 pb-xs-1 mb-xs-4" onClick={() => navigate(`/artist/${state.artistSlug}/leaderboard-flash`, { state: state })}>
