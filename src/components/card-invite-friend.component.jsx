...
const CardInviteFriend = ({ artist }) => {
    ...
    return (
        <article className='d-flex-row align-items-center j-c-space-between bg-purple-gradient pb-xs-3 pt-xs-3 pr-xs-6 pl-xs-6 border-radius-1 mt-xs-12' onClick={() => navigate(`/artist/${artist?.slug}/invite-friend`, {state: artist})}>
