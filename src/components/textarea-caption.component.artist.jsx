...
const TextAreaCaption = ({ showTextArea, handleTextAreaVisibility }) => {
    return (
        <div className={`position-fixed bottom-hidden bg-dark w-100 full-screen-modal ${showTextArea ? 'slide-up' : 'slide-down'}`}>
            <ContainerDefault containerSpecificStyle={'pt-xs-4 pb-xs-4'}>
                <textarea className='bg-dark-soft white letter-spacing-1 border-radius-04' placeholder='Scrivi qui la caption...' rows='6'></textarea>
