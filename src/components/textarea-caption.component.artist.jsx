...
const TextAreaCaption = ({ showTextArea, handleTextAreaVisibility, handleCaption, caption }) => {
    return (
        <div className={`position-fixed bottom-hidden bg-dark-soft w-100 border-radius-top-08 z-index-1100 ${showTextArea ? 'slide-up' : 'slide-down'}`}>
            <Container style={'pt-xs-4 pb-xs-4'}>
                <textarea className='bg-dark white letter-spacing-1 border-radius-04' placeholder='Scrivi qui la caption...' rows='6' value={caption} onChange={handleCaption}></textarea>
